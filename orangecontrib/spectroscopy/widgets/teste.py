...
class MyLine(pg.LineSegmentROI):
    def __init__(self, positions=(None, None), pos=None, handles=(None,None), **args):
        super().__init__(positions, pos, handles, **args)

        super().setPos([QtCore.QPointF(0.,0.), QtCore.QPointF(20.,20.)]) 
